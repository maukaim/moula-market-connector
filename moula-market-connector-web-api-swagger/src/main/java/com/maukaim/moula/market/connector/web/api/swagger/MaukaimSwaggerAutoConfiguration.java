package com.maukaim.moula.market.connector.web.api.swagger;

import com.maukaim.moula.market.connector.web.api.swagger.config.DocketCustomizer;
import com.maukaim.moula.market.connector.web.api.swagger.config.MaukaimSwaggerProperties;
import com.maukaim.moula.market.connector.web.api.swagger.config.SwaggerConfigCustomizer;
import com.maukaim.moula.market.connector.web.api.swagger.config.springfox.SpringfoxConfigurationProperties;
import com.maukaim.moula.market.connector.web.api.swagger.config.springfox.SwaggerUiWebFluxConfiguration;
import com.maukaim.moula.market.connector.web.api.swagger.config.springfox.SwaggerUiWebMvcConfiguration;
